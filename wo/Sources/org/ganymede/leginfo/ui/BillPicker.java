...
public class BillPicker extends GComponent {

	public BillPicker(WOContext context) {
        super(context);
    }
    ...
    @edu.umd.cs.findbugs.annotations.SuppressWarnings(
    		...
    		justification="WORepetition in BillPicker.wod which supplies instances of billType from billTypes().")
    ...
    @edu.umd.cs.findbugs.annotations.SuppressWarnings(
    		value="NP_UNWRITTEN_PUBLIC_OR_PROTECTED_FIELD",
    		justification="WORepetition in BillPicker.wod which supplies instances of section from sections().")

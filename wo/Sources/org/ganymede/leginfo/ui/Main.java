...
public class Main extends ERXComponent {
	...
	public NSArray<EOEnterpriseObject> billTypes() {
		return EOUtilities.objectsForEntityNamed(session().defaultEditingContext(), "BillType");
	}
	...
	public EOEnterpriseObject section;

	public NSArray<EOEnterpriseObject> sections() {
		return EOUtilities.objectsForEntityNamed(session().defaultEditingContext(), "CodeSection");
	}
